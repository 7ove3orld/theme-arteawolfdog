...
<div class="title-splash splash-screen left-panel">
  ...
  <a class="btn-img" href="javascript:splashScreenDoneForced();">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/title.png" alt="Wolfdog Title Left">
  </a>
</div>
<div class="title-splash splash-screen right-panel">
  <!-- 2sec max OU click -->
  <a class="btn-img" href="javascript:splashScreenDoneForced();">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/title.png" alt="Wolfdog Title Right">
  </a>
</div>
<div class="logo-splash splash-screen left-panel">
  <!-- 2sec max OU click -->
  <a class="btn-img" href="javascript:splashScreenDoneForced();">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt="Wolfdog Left">
  </a>
</div>
<div class="logo-splash splash-screen right-panel">
  <!-- 2sec max OU click -->
  <a class="btn-img" href="javascript:splashScreenDoneForced();">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt="Wolfdog Right">
  </a>
</div>
